...
public class ListaEncadeada<T> {
	...
	/**Teste para busca binária, este algoritmo também contém no trabalho 1 
	 * e faz a busca binária para um Contato da lista telefônica na classe RepositorioContato*/
